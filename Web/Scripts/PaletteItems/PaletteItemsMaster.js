var PaletteItemsMaster = kendo.Class.extend({
    ...
    _initializeView: function () {
        ...
        if (actionName == "editPaletteItem") {
            var id = this._getParameterByName("paletteItemId");
            that.get_form().show(id);
        }
        else if (actionName == "newPaletteItem") {
            that.get_form().show();
        }
    },
        ...
        $(this._masterElements.sortingDropDownList).kendoDropDownList({
            ...
            change: function (e) {
                ...
                if (e.sender.dataItem().value == "custom") {
                    $(that._masterElements.customSortingPaletteItemPropertiesDropDownList).kendoDropDownList({
                        dataTextField: "Name",
                        dataValueField: "Name",
                        dataSource: that.get_paletteItemPropertiesDataSource()
                    });
                    that.set_customSortingPaletteItemPropertiesDropDownList($(that._masterElements.customSortingPaletteItemPropertiesDropDownList).data("kendoDropDownList"));
    ...
    _initializeCustomSortingDialog: function (dialogSettings) {
        ...
        this.set_paletteItemPropertiesDataSource(propertiesDataSource);
        ...
        $(this._masterElements.saveCustomSortingButton).click(function () {
            var selectedProperty = that.get_customSortingPaletteItemPropertiesDropDownList().value();
        ...
        if ($(me._masterElements.batchDeleteButton).is('.sfDisabledLinkBtn')) {
            ...
            $(me._masterElements.batchDeleteButton).on('click', function () {
                ...
                if (checkedTextBoxes.length == 1) {
                    ...
                    $(me._masterElements.batchDeletePaletteItemCountLabel).text(checkedTextBoxes.length);
    ...
    get_paletteItemPropertiesDataSource: function () {
        return this._paletteItemPropertiesDataSource;
    },
    set_paletteItemPropertiesDataSource: function (dataSource) {
        this._paletteItemPropertiesDataSource = dataSource;
    },

    get_customSortingPaletteItemPropertiesDropDownList: function () {
        return this._customSortingPaletteItemPropertiesDropDownList;
    },
    set_customSortingPaletteItemPropertiesDropDownList: function (dropDownList) {
        this._customSortingPaletteItemPropertiesDropDownList = dropDownList;
    },
    ...
    _masterElements: {
        masterGrid: "#paletteItemsGrid",
        pagesWrapper: "#pagesWrapper",
        masterRowTemplate: "#paletteItemsRowTemplate",
        decisionScreen: "#paletteItemsDecisionScreen",
        checkAllCheckbox: "#checkAllCheckbox",
        deleteConfirmationDialog: "#deletePaletteItemConfirmationDialog",
        confirmDeleteButton: "#confirmPaletteItemDeleteButton",
        cancelDeleteButton: "#cancelDeletePaletteItemButton",
        batchDeleteButton: "#deleteUserPaletteItems",
        batchDeleteConfirmationDialog: "#batchDeletePaletteItemConfirmationDialog",
        batchDeletePaletteItemCountLabel: "#batchDeletePaletteItemCountLabel",
        confirmBatchDeleteButton: "#confirmPaletteItemBatchDeleteButton",
        cancelBatchDeleteButton: "#cancelBatchDeletePaletteItemButton",
        sortingDropDownList: "#sortingDropDownList",
        customSortingDialog: "#paletteItemCustomSortingDialog",
        customSortingPaletteItemPropertiesDropDownList: "#customSortingPaletteItemPropertiesDropDownList",
    ...
    _paletteItemPropertiesDataSource: null,
    _customSortingPaletteItemPropertiesDropDownList: null,
